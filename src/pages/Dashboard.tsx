...
// Illustrative only: the dashboard never collects real browsing telemetry.
const exampleEvents = [
...
export function Dashboard() {
  ...
  // Read the Stripe redirect result once, at first render.
  ...
  const canExport = licensed

  // The webhook usually lands seconds after the redirect; promote the banner
  // as soon as the license shows up. State adjustment during render keeps the
  // polling effect below free of synchronous setState calls.
  if (checkoutBanner === 'activating' && licensed) {
    setCheckoutBanner('active')
  }

  // Clean the ?checkout=… marker out of the URL after the redirect.
  useEffect(() => {
  ...
  // Poll the entitlement endpoint until the webhook grants the license.
  useEffect(() => {
  ...
  const requireLicense = useCallback(() => {
    if (canExport) {
      return true
    }
    ...
    <main className="app-shell">
      <aside className="sidebar" aria-label="Aegis navigation">
        ...
        <section className="license-panel" id="license">
          ...
          <button className="soft-button" type="button" onClick={canExport ? downloadRules : () => void startCheckout()}>
      ...
      <section className="workspace">
        ...
        <header className="topbar">
          ...
          <div className="topbar-actions">
            ...
            <button className="primary-button" type="button" onClick={canExport ? downloadRules : () => void startCheckout()}>
        ...
        <section className="summary-grid" id="protection">
          ...
          <article className="status-card compact">
            ...
            <button className="toggle-control" type="button" onClick={canExport ? downloadRules : () => void startCheckout()}>
        ...
        <section className="content-grid">
          ...
          <section className="panel billing-panel">
            ...
            {!configured ? (
              ...
              <div className="account-stack">
                ...
                <div className="button-row">
                  <button
                    ...
                    type="button"
                    onClick={canExport ? () => void refreshEntitlement() : () => void startCheckout()}
                  >
              ...
              <form className="auth-form" onSubmit={onSendMagicLink}>
          ...
          <section className="panel activity-panel">
            <div className="panel-heading">
              <div>
                ...
                <h2>What blocking looks like</h2>
              </div>
              <Radar size={20} />
            </div>
            ...
            <p className="activity-note">
              Illustrative example — Aegis never collects your real browsing activity.
            </p>
          </section>
        </section>
      </section>
